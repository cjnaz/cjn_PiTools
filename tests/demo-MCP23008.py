...
__version__ =   '1.0'
TOOLNAME =      'demo_MCP23008'
DIG_2_SEG = {-1 : 0x00,
              0 : 0x3f,  1 : 0x06,  2 : 0x5b,  3 : 0x4f,  4 : 0x66,  5 : 0x6d,  6 : 0x7d,  7 : 0x07,  8 : 0x7f,  9 : 0x67,
             10 : 0x77, 11 : 0x7c, 12 : 0x39, 13 : 0x5e, 14 : 0x79, 15 : 0x71, 16 : 0x49, 17 : 0x40, 18 : 0x36, 19 : 0x80,
             'A': 0x77, 'B': 0x7c, 'C': 0x39, 'D': 0x5e, 'E': 0x79, 'F': 0x71, '=': 0x49, '-': 0x40, '|': 0x36, '.': 0x80 }
...
MCP23008_7SEG_ADDR =    0x21
MCP23008_IO_inst_pio =  mcp23008('MCP23008_IO', MCP23008_IO_ADDR, pio_i2c_bus_handle,
                                 IO_dir_init=0xF0, out_bits_init=0x00, ins_pullups_init=0xf0)
MCP23008_7SEG_inst_pio= mcp23008('MCP23008_7SEG', MCP23008_7SEG_ADDR, pio_i2c_bus_handle,
                                 IO_dir_init=0x00, out_bits_init=0xff, ins_pullups_init=0x00)
...
if __name__ == '__main__':
    ...
    if check_tnum('1a'):
        def func():
            MCP23008_7SEG_inst_pio.set_bits(~DIG_2_SEG[5], 0xff)
            return f"0x{MCP23008_7SEG_inst_pio.read_bits():0>2x}"

        dotest ("Display '5'", "Pass", func)
